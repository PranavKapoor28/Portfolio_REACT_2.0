    ...
    return (
        <MainContainer>
            ...
            <Container>
                ...
                <Center click={click}>
                    <YinYang onClick={() => handleClick()} width={click ? 100 : 900} height={click ? 120 : 200} fill='currentColor' />
                    <span><b>Click here</b></span>
                </Center>

                <Contact target="_blank" to={{ pathname: "mailto:pranavkapoor2k09@gmail.com" }}>
                    <motion.h2
                        initial={{
                            y: -200,
